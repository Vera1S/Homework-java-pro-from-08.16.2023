...
public class MainPerson {
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println(person1.name + "-" + person1.getMoney(2500) + "$");
        System.out.println(person2.name + "-" + person2.getMoney(4000) + "$");
        System.out.println(person3.name + "-" + person3.getMoney(1500) + "$");
